...
export function registerFlowRoutes(app, flowMonitor, gpio) {
    ...
    app.get('/api/flow/readings', async (req) => {
    ...
    app.put('/api/flow/settings', async (req) => {
        const keyMap = {
