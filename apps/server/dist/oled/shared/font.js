...
export function drawChar(fb, x, y, ch, invert = false) {
...
export function drawText(fb, x, y, text, invert = false) {
...
export function drawTextRight(fb, x, y, text) {
    drawText(fb, x - textWidth(text), y, text);
}
export function drawTextCenter(fb, y, text) {
