...
export function renderZoneControl(fb, state, selectedIndex) {
    // Header
    ...
    const scrollOffset = Math.max(0, Math.min(selectedIndex - Math.floor(VISIBLE_ROWS / 2), totalItems - VISIBLE_ROWS));
...
export function zoneControlTotal(zoneCount) {
    return zoneCount + 1;
}
//# sourceMappingURL=zone-control.js.map