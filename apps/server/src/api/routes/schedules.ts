...
export function registerScheduleRoutes(app: FastifyInstance, zoneManager: ZoneManager): void {

  // GET /api/schedules — list all schedules
  app.get<{ Querystring: { zone?: string } }>('/api/schedules', async (req) => {
  ...
  app.put<{ Params: { id: string }; Body: Partial<ScheduleInput> }>(
    '/api/schedules/:id',
    async (req, reply) => {
