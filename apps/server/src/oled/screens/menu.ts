...
const ALL_ITEMS = [...MENU_ITEMS, 'Back'] as const;

export function renderMenu(fb: FrameBuffer, selectedIndex: number): void {
  ...
  if (visibleStart > 0) {
    ...
    fb.setPixel(123, LIST_START_Y + 2); fb.setPixel(125, LIST_START_Y + 2);
  }
  if (visibleEnd < total) {
